...
ms.locfileid: "137909005"
---
<a name="module-1-learn-the-fundamentals-of-dynamics-365-marketing"></a>모듈 1: Dynamics 365 마케팅의 기본 사항 알아보기
========================

## <a name="practice-lab-16---create-a-simple-customer-journey"></a>연습 랩 1.6 - 간단한 고객 여정 만들기
...
9. 시카고 연락처 스윔 레인에서 **+** 를 선택한 후에 상황에 맞는 메뉴에서 **메일 보내기** 를 선택합니다.
