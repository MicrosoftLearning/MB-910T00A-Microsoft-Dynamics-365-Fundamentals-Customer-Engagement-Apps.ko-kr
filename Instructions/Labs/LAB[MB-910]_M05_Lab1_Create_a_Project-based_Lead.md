...
## <a name="practice-lab-51-create-a-project-based-lead"></a>연습 랩 5.1: 프로젝트 기반 잠재 고객 만들기
...
## <a name="exercise-1-create-a-project-based-lead"></a>연습 1: 프로젝트 기반 잠재 고객 만들기
...
### <a name="task-2-qualify-the-lead-and-convert-to-opportunity-for-further-qualification"></a>작업 2: 잠재 고객을 선별하고 추가 선별을 위해 영업 기회로 변환
